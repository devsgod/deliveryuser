...
export class OrderDetailPage implements OnInit {
  ...
  printOrder() {
    ...
    const content = '<div style="padding: 20px;display: flex;flex-direction: column;"> <img src="assets/icon.png" style="text-align: center; height: 100px;width: 100px;" alt=""> <h2 style="text-align: center;">Foodies Order Summary</h2> <p style="float: left;margin:0px;"><b>' +
      this.id + '</b></p> <p style="float: left;margin:0px;"><b>' + this.restName + '</b></p> <p style="float: left;margin:0px;"><b>' + this.userName + '</b></p> <p style="float: left;margin:0px;">' + this.time + ' </p> <p style="font-weight: bold;margin:0px;">' + this.util.translate('ITEMS') + '</p> ' + order + ' <p style="border-bottom: 1px solid black;margin:0px;"><span style="float: left;font-weight: bold;">' + this.util.translate('SubTotal') + '</span> <span style="float: right;font-weight: bold;">' + this.getCurrency() + this.total + '</span> <p style="border-bottom: 1px solid black;"><span style="float: left;font-weight: bold;">' + this.util.translate('Delivery Charge') + '</span> <span style="float: right;font-weight: bold;">' + this.getCurrency() + '2.99</span> </p> <p style="border-bottom: 1px solid black;"><span style="float: left;font-weight: bold;">' + this.util.translate('Service Tax') + '</span> <span style="float: right;font-weight: bold;">' + this.getCurrency() +
